...
// To accept the files supported by OS SHP Builder.
{$R-,H+,X+}

interface

uses Messages, Windows, SysUtils, Classes, Controls, StdCtrls, Graphics,
  ExtCtrls, Buttons, Dialogs, SHP_Image_Save_Load;
...
// The main change is here. The component Bitmap is added and
// used.
...
begin
  ...
  begin
    ...
    try
      TBitmap.Create;
      Bitmap := GetBMPFromImageFile(FullName);
      FImageCtrl.Picture.Assign(Bitmap); //.LoadFromFile(FullName);
